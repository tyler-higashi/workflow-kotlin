...
class PerformancePoetryActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val processMultipleActions = intent.getBooleanExtra(EXTRA_RUNTIME_MULTIPLE_ACTIONS, false)
    val runtimeConfig = RuntimeConfig(processMultipleActions = processMultipleActions)
  ...
  private fun setupMainLooperTracing() {
    ...
    if (traceMain || traceSelectOnTimeout && Build.VERSION.SDK_INT != 28 &&
  ...
  companion object {
    ...
    const val EXTRA_RUNTIME_MULTIPLE_ACTIONS =
      "complex.poetry.performance.config.runtime.actions"
